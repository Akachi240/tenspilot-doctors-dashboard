...
addDashedPlaceholder(slide8, 0.5, 1.1, 5.5, 3.8, "Doctor Dashboard\nScreenshot\n\n(Overview Stats, Pain Charts,\nSession History)");
slide8.addText("Clinical Oversight Tools", { x: 6.3, y: 1.5, w: 3.0, h: 0.5, fontFace: "Calibri", fontSize: 22, bold: true, color: c.mint });
slide8.addText("• Remote Session Tracking\n\n• Patient Compliance Analytics\n\n• Real-Time Progress Charts\n\n• Secure Cloud Synchronization", { x: 6.3, y: 2.2, w: 3.0, h: 2.5, fontFace: "Calibri", fontSize: 18, color: c.white });
...
pptx.writeFile({ fileName: "TensPilot_DarkTheme_Final.pptx" }).then(() => {
