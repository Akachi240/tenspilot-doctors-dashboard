...
const c = {
    bg: "0B1320",         // Very dark navy background
    mint: "2DD4BF",       // Mint green (teal)
    white: "F8FAFC",      // Off-white text
    lightGray: "94A3B8",  // Subtext / subtle text
    panelBg: "1E293B",    // Slightly lighter navy for panels
    panelBorder: "334155", // Subtle border for panels
    orange: "FB923C",     // Accent for problems/warnings
    blue: "3B82F6"        // Accent for software
};
...
slide5.addText("• Live Logging\n\n• Pain Tracking Algorithm\n\n• Therapy Suggestions\n\n• Offline Access (PWA)", { x: 7.0, y: 2.2, w: 2.5, h: 2.5, fontFace: "Calibri", fontSize: 16, color: c.white });

// --- SLIDE 6: SOFTWARE ECOSYSTEM (DOCTOR) ---
let slide6 = pptx.addSlide({ masterName: "DARK_MASTER" });
addContentTitle(slide6, "5. Ecosystem: Doctor Dashboard");
...
slide7.addText("Gemini-Powered Capabilities", { x: 4.8, y: 1.5, w: 4.7, h: 0.5, fontFace: "Calibri", fontSize: 20, bold: true, color: c.white });
slide7.addText("• Recommends electrode placement based on pain type.\n• Provides therapy guidance 24/7.", { x: 4.8, y: 2.1, w: 4.7, h: 1.0, fontFace: "Calibri", fontSize: 16, color: c.lightGray, lineSpacing: 15 });

slide7.addText("Key Benefits", { x: 4.8, y: 3.2, w: 4.7, h: 0.5, fontFace: "Calibri", fontSize: 20, bold: true, color: c.mint });
slide7.addText("• Reduces patient misinformation.\n• Improves therapy adherence and confidence.", { x: 4.8, y: 3.8, w: 4.7, h: 1.0, fontFace: "Calibri", fontSize: 16, color: c.lightGray, lineSpacing: 15 });
...
pptx.writeFile({ fileName: "TensPilot_DarkTheme_12Slides.pptx" }).then(() => {
